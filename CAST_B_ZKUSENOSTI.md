...
Mezi moje rozvojové oblasti patří hlavně hlubší práce s AI automatizacemi, návrhem vlastních agentů, no-code/low-code workflow a lepším napojováním webů na externí služby přes API. Chci se dál zlepšovat v nástrojích jako n8n, práci s prompty, návrhu jednoduché persistence pro AI agenty a ve stavbě řešení, která kombinují web, data a automatizaci. Z technického pohledu mě dál zajímá React/Next.js, TypeScript a PHP, ale spíš jako prostředky pro tvorbu praktičtějších AI/web řešení než jako samostatný cíl. Angličtinu zvládám hlavně pro čtení technické dokumentace a postupně zlepšuji mluvení.

Kariérně mě nejvíc zajímá kombinace web developmentu, AI automatizací a praktických integrací. Baví mě WordPress/WooCommerce, frontend, e-commerce, API, importy a XML feedy, ale rád bych na tom stavěl směrem k AI workflow, vlastním agentům, automatizacím pro klienty a chytrým webovým řešením. Láká mě práce, kde se neřeší jen jednotlivé tickety, ale přemýšlí se nad tím, jak pomocí webu, dat a AI zjednodušit reálný proces.
